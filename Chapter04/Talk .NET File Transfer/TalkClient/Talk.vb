...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cmdOffer As System.Windows.Forms.Button
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdOffer = New System.Windows.Forms.Button()
        ...
        Me.txtReceived.Location = New System.Drawing.Point(8, 21)
        ...
        Me.txtReceived.Size = New System.Drawing.Size(354, 171)
        ...
        Me.cmdSend.Location = New System.Drawing.Point(320, 19)
        ...
        Me.txtMessage.Location = New System.Drawing.Point(4, 21)
        ...
        Me.lstUsers.Size = New System.Drawing.Size(144, 21)
        ...
        'cmdOffer
        '
        Me.cmdOffer.FlatStyle = System.Windows.Forms.FlatStyle.System
        Me.cmdOffer.Location = New System.Drawing.Point(296, 252)
        Me.cmdOffer.Name = "cmdOffer"
        Me.cmdOffer.Size = New System.Drawing.Size(76, 20)
        Me.cmdOffer.TabIndex = 7
        Me.cmdOffer.Text = "Offer a File"
        '
        'Talk
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 14)
        Me.ClientSize = New System.Drawing.Size(380, 346)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.cmdOffer, Me.lstUsers, Me.Label1, Me.Label2, Me.GroupBox2, Me.GroupBox1})
...
#End Region
    ...
    Private Sub cmdSend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSend.Click
        ...
        ' Send the message through the ClienProcess object.
    ...
    Private Sub TalkClient_FileOfferReceived(ByVal sender As Object, ByVal e As TalkClient.FileOfferReceivedEventArgs) Handles TalkClient.FileOfferReceived
        ...
        ' Fortunately the MessageBox.Show method is threadsafe,'
        ' saving some work.
        Dim Result As DialogResult = MessageBox.Show(Message, "File Transfer Offered", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        ...
        If Result = DialogResult.Yes Then
            ...
            Try
                ...
                ' Receive the file.
                TalkClient.AcceptFile(e.SenderAlias, e.FileIdentifier, DestinationPath)

                ' Assuming no error occurred, display information about it in the chat window.
                Dim NewText As String
            ...
            Catch err As Exception
                MessageBox.Show(err.Message, "Transfer Failed", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
