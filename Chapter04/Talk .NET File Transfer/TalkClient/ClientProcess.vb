...
Public Class ClientProcess
    ...
    Public Function SendFileOffer(ByVal recipientAlias As String, ByVal sourcePath As String)
        ...
        ' Offer the file.
        Dim FileOffer As New ReceiveFileOfferDelegate(AddressOf peer.ReceiveFileOffer)
        FileOffer.BeginInvoke(Path.GetFileName(sourcePath), fileIdentifier, Me.Alias, Nothing, Nothing)
