Public Interface ITalkServer
    ...
    ' The client calls this to retrieve a reference to another client.
    Function GetUser(ByVal [alias] As String) As ITalkClient

End Interface

Public Delegate Sub ReceiveFileOfferDelegate(ByVal filename As String, ByVal fileIdentifier As System.Guid, ByVal senderAlias As String)
